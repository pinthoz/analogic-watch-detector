...
def save_detections(results, output_file="detections/detections6.json"):
    """
...
def load_detections(input_file="detections/detections6.json"):
    """
...
image_path = "examples/watch_test6.jpg"
output_path = "examples/output6.jpg"
